...
<body>
	...
	<div class="login-container">
		<div class="login-content">
			...
			<form action="php/iniciar_sesion.php" class="needs-validation" novalidate method="POST">
				...
				<button type="submit" name="ingresar" class="btn-login text-center">LOGIN</button>
			</form>
			</form>
		</div>
	</div>
