...
<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="client-new.php" method="POST" class="form-neon" autocomplete="off">
					<fieldset>
							...
							<div class="row">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text"  class="form-control" id="cliente_identificacion" name="identi" maxlength="12" onKeyPress="return soloNumeros(event)" required="">
									</div>
							</div>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text"  class="form-control" name="nombre" id="cliente_nombre" maxlength="20" onkeypress="return soloLetras(event)" required="">
									</div>
								</div>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text"  class="form-control" name="apellido" id="cliente_apellido" maxlength="20" onkeypress="return soloLetras(event)" required="">
									</div>
								</div>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="date"  class="form-control" id="cliente_fecha" name="fecha"  required="">
									</div>
								</div>	
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="cliente_direccion" class="bmd-label-floating">	Direccion *</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="direccion" id="cliente_direccion" maxlength="20" required="">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="cliente_telefono" class="bmd-label-floating">Telefono *</label>
										<input type="number"   class="form-control" name="telefono" id="cliente_telefono" maxlength="10" onKeyPress="return soloNumeros(event)" required="">
									</div>
								</div>
								<div class="col-12 col-md-6">
                                    <div class="form-group">
                                        <label for="item_correo" class="bmd-label-floating">Correo electronico *</label>
                                        <input type="text"  class="form-control" name="correo" id="item_correo" maxlength="50" required="">
                                    </div>
                                </div>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text"  class="form-control" name="usuario" id="cliente_usuario" maxlength="20" required="">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="cliente_contraseña" class="bmd-label-floating">Contraseña </label>
										<input type="text"  class="form-control" name="contrasena" id="cliente_contraseña" maxlength="20" required="">
									</div>
								</div>
							</div>
						</div>
...
mysqli_query($CNX,"INSERT INTO usuarios(tipo_id, n_id, apellido, nombre, sexo, nacimiento, direccion, telefono, correo, usuario, contrasena)VALUES('$tipo','$identi','$Nombre', '$Apellido','$Sexo','$Fecha_nacimiento','$Direccion','$Telefono','$Correo','$Usuario','$Contrasena')");
}
?>	
