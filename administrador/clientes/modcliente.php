...
<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="modcliente.p" method="POST" class="form-neon" autocomplete="off">
					<fieldset>
            ...
            $consulta = "SELECT * FROM usuarios WHERE id_us = '$id_usuario'";
							...
							<div class="row">
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text"  class="form-control" id="cliente_identificacion" name="identi" maxlength="27" onKeyPress="return soloNumeros(event)" required=""  value="<?php echo $columna['n_id'];?>">
									</div>
							</div>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text"  class="form-control" name="nombre" id="cliente_nombre" maxlength="40" onkeypress="return soloLetras(event)" required=""  value="<?php echo $columna['nombre'];?>">
									</div>
								</div>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="text"  class="form-control" name="apellido" id="cliente_apellido" maxlength="40" onkeypress="return soloLetras(event)" required=""  value="<?php echo $columna['apellido'];?>">
									</div>
								</div>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										...
										<input type="date"  class="form-control" id="cliente_fecha" name="fecha" maxlength="27" required=""  value="<?php echo $columna['nacimiento'];?>">
									</div>
								</div>	
								<div class="col-12 col-md-6">
									<div class="form-group">
